...
module.exports = function(T2gpleakdetailscontract) {

  T2gpleakdetailscontract.processChild = function(req, filter, cb) {
      ...
      T2gpleakdetailscontract.remoteMethod('processChild', {
          http: {path: '/', verb: 'get', status: 200},
          accepts: [{arg: 'data', type: 'object',  http: {source: 'req'} },
                      {arg: 'filter', type: 'object'}],
          returns: {arg: 't2GPLeakDetailsContract', type: 'object'}
      });
