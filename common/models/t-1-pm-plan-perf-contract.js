...
module.exports = function (T1PMPlanPerfContract) {
  T1PMPlanPerfContract.processChild = function (req, filter, cb) {
  ...
  T1PMPlanPerfContract.remoteMethod('processChild', {
    http: { path: '/', verb: 'get', status: 200 },
    accepts: [{ arg: 'data', type: 'object', http: { source: 'req' } },
    { arg: 'filter', type: 'object' }],
    returns: { arg: 't1PMPlanPerfContract', type: 'object' }
  });
