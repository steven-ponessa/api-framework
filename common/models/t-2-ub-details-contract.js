...
module.exports = function(T2ubdetailscontract) {
    T2ubdetailscontract.processChild = function(req, filter, cb) {
    ...
    try {
        ...
        if(message.length > 0) { //Avoid processing a empty result set
            ...
            "CONTRACT_NBR_LABEL":"Contract",
            "SECTOR_LABEL":"Sector",
            "UNBILLED_LABEL":ub_label,
            "VALUE_LABEL":value_label,
            "CLOSE_DATE_LABEL":"End Date",            
          }
          ...
          formatedJson.data = [];
            ...
            for (var i = 0; i < message.length; i++) {
              ...
              formatedJson.data.push({
                ...
                "closed_date":message[i].CLOSED_DT,
              });
            };
  ...
  T2ubdetailscontract.remoteMethod('processChild', {
      http: {path: '/', verb: 'get', status: 200},
      accepts: [{arg: 'data', type: 'object',  http: {source: 'req'} },
                  {arg: 'filter', type: 'object'}],
      returns: {arg: 't2UBDetailsContract', type: 'object'}
  });
};
