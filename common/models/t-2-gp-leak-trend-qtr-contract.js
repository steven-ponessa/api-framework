...
module.exports = function(T2gpleaktrendqtrcontract) {
  T2gpleaktrendqtrcontract.processChild = function(req, filter, cb) {
...
*/
  ...
  T2gpleaktrendqtrcontract.remoteMethod('processChild', {
    http: {path: '/', verb: 'get', status: 200},
    accepts: [{arg: 'data', type: 'object',  http: {source: 'req'} },
              {arg: 'filter', type: 'object'}],
              returns: {arg: 't2GPLeakTrendQtrContract', type: 'object'}
  });
