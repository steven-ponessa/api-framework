...
module.exports = function(T2ubalertcontract) {
  T2ubalertcontract.processChild = function(req, filter, cb) {
  ...
  T2ubalertcontract.remoteMethod('processChild', {
      http: {path: '/', verb: 'get', status: 200},
      accepts: [{arg: 'data', type: 'object',  http: {source: 'req'} },
                  {arg: 'filter', type: 'object'}],
      returns: {arg: 't2UBAlertContract', type: 'object'}
  });
};
