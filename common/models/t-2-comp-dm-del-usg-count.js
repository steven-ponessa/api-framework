...
module.exports = function(T2compdmdelusgcount) {

  T2compdmdelusgcount.processChild = function(req, filter, cb) {
...
/*               // might need to check if empty
    ...
    T2compdmdelusgcount.remoteMethod('processChild', {
        http: {path: '/', verb: 'get', status: 200},
        accepts: [{arg: 'data', type: 'object',  http: {source: 'req'} },
                    {arg: 'filter', type: 'object'}],
        returns: {arg: 't2CompDMDelUsgCount', type: 'object'}
    });
