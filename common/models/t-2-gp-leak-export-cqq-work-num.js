...
module.exports = function(T2gpleakexportcqqworknum) {
  T2gpleakexportcqqworknum.processChild = function(req, filter, cb) {
...
/*    var signedValue = '';
  ...
  T2gpleakexportcqqworknum.remoteMethod('processChild', {
      http: {path: '/', verb: 'get', status: 200},
      accepts: [{arg: 'data', type: 'object',  http: {source: 'req'} },
                  {arg: 'filter', type: 'object'}],
      returns: {arg: 't2GPLeakExportCQQWorkNum', type: 'object'}
  });
};
