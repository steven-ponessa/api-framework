...
module.exports = function(T2compgdprpopupcontract) {

    T2compgdprpopupcontract.processChild = function(req, filter, cb) {
        this.process(req, filter, function(err, message){
          ...
          try {
            ...
            if (message.length > 0 ) {
              ...
              "PRTNR_NM": message[0].PARTNER_NAME,
              "CNTRCT_SIGN_DATE": message[0].CONTRACT_SIGN_DATE,
              "GEO": message[0].GEO,
              "PRACTISE": message[0].PRACTISE,
              "INDUSTRY": message[0].INDUSTRY,
              ...
              "CNTRCT_END_DATE": message[0].CONTRACT_END_DT,
    ...
    T2compgdprpopupcontract.remoteMethod('processChild', {
        http: {path: '/', verb: 'get', status: 200},
        accepts: [{arg: 'data', type: 'object',  http: {source: 'req'} },
                    {arg: 'filter', type: 'object'}],
        returns: {arg: 't2CompGDPRPopupContract', type: 'object'}
    });
