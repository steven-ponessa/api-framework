...
module.exports = function(T2compdmsolusgtrend) {
  T2compdmsolusgtrend.processChild = function(req, filter, cb) {
      ...
      if (!message.length <= 0) {
        ...
        switch (req.query['metric']) { 
          ...
          case "NCOM":
            metColor = "#4D5358";
            metLabel = "Solutioning: Not Compliant";
          break;
          case "APR":
            metColor = "#26D181";
    ...
    T2compdmsolusgtrend.remoteMethod('processChild', {
    http: {path: '/', verb: 'get', status: 200},
    accepts: [{arg: 'data', type: 'object',  http: {source: 'req'} },
              {arg: 'filter', type: 'object'}],
              returns: {arg: 't2CompDMSolUsgTrend', type: 'object'}
  });
