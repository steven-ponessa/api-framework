...
module.exports = function(T2ubtrendworknum) {
  T2ubtrendworknum.processChild = function(req, filter, cb) {
...
T2ubtrendworknum.remoteMethod('processChild', {
    http: {path: '/', verb: 'get', status: 200},
    accepts: [{arg: 'data', type: 'object',  http: {source: 'req'} },
              {arg: 'filter', type: 'object'}],
              returns: {arg: 't2UBTrendWorkNum', type: 'object'}
  });
};
