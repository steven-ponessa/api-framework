...
module.exports = function(T2actportdetailscontract) {
  T2actportdetailscontract.processChild = function(req, filter, cb) {
        ...
        var formatedJson = {
          ...
          if(message.length == 0) { 
            ...
            formatedJson = {
              ...
              "RISK_GP_DET_HDR":"Risk of GP Deterioration",
              "TCV_HDR":"TCV $",
              ...
              "CPLX_MET_NON_COMPL_COUNT_HDR":"Non Compliant Count",
          ...
          formatedJson.data = [];
            ...
            for (var i = 0; i < message.length; i++) {
              ...
              if ( message[i].DELIVERY_START_LABEL == 'Non Compliant') {
                non_compl_count++;
              ...
              formatedJson.data.push({
                ...
                "PROJ_INFO_CIC_COLOR":message[i].CIC_SCORE_COLOR,
                ...
                "RISK_GP_DET":calcs.formatAmount(Number(message[i].OVERALL_RISK)),
                "TCV":message[i].TCV,
                ...
                "CPLX_MET_RO_ACT_COLOR":message[i].RO_ACT_CREATED_COLOR,
                "CPLX_MET_RO_OVRDUE_ACT":message[i].RO_OVRDUE_ACT,
                "CPLX_MET_RO_OVRDUE_ACT_COLOR":message[i].RO_OVRDUE_ACT_COLOR,
                ...
                "CPLX_MET_NON_COMPL_COUNT_HOVER": non_compl_count_hover,
  ...
  T2actportdetailscontract.remoteMethod('processChild', {
      http: {path: '/', verb: 'get', status: 200},
      accepts: [{arg: 'data', type: 'object',  http: {source: 'req'} },
                  {arg: 'filter', type: 'object'}],
      returns: {arg: 't2ActPortDetailsContract', type: 'object'}
  });
};
