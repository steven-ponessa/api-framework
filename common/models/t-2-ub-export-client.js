...
module.exports = function(T2ubexportclient) {
    T2ubexportclient.processChild = function(req, filter, cb) {
  ...
  T2ubexportclient.remoteMethod('processChild', {
      http: {path: '/', verb: 'get', status: 200},
      accepts: [{arg: 'data', type: 'object',  http: {source: 'req'} },
                  {arg: 'filter', type: 'object'}],
      returns: {arg: 't2UBExportClient', type: 'object'}
  });
};
