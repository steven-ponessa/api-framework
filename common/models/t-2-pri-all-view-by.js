...
module.exports = function(T2priallviewby) {
  T2priallviewby.processChild = function(req, filter, cb) {
  ...
  T2priallviewby.remoteMethod('processChild', {
      http: {path: '/', verb: 'get', status: 200},
      accepts: [{arg: 'data', type: 'object',  http: {source: 'req'} },
                  {arg: 'filter', type: 'object'}],
      returns: {arg: 't2PriAllViewBy', type: 'object'}
  });
};
