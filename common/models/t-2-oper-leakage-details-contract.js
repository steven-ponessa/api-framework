...
module.exports = function(T2operleakagedetailscontract) {

    T2operleakagedetailscontract.processChild = function(req, filter, cb) {
          this.process(req, filter, function(err, message){
			...
			switch (req.query['metric']) {
				...
				case "FC_TO_PC":lkg_pct_label  = "FC EaC to PC %";  lkg_label = "FC EaC to PC $";  break;
				case "CQ_TO_PC":lkg_pct_label  = "CQ EaC to PC %";  lkg_label = "CQ EaC to PC $";  break;
				case "AP_TO_PC":lkg_pct_label  = "AP EaC to PC %";  lkg_label = "AP EaC to PC $";  break;
				case "FC_TO_AP":lkg_pct_label  = "FC EaC to AP %";  lkg_label = "FC EaC to AP $";  break;
			};
			var formatedJson = {};
      ...
      T2operleakagedetailscontract.remoteMethod('processChild', {
          http: {path: '/', verb: 'get', status: 200},
          accepts: [{arg: 'data', type: 'object',  http: {source: 'req'} },
                      {arg: 'filter', type: 'object'}],
          returns: {arg: 't2OperLeakageDetailsContract', type: 'object'}
      });
