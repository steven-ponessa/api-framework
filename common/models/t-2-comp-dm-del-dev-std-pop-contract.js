...
module.exports = function(T2compdmdeldevstdpopcontract) {

  T2compdmdeldevstdpopcontract.processChild = function(req, filter, cb) {
              ...
              "data":[]
                ...
                if (!message.length <= 0) { 
                  formatedJson.data.push({
                    ...
                    "PROJ_NAME": message[0].PROJECT_NM,
    ...
    T2compdmdeldevstdpopcontract.remoteMethod('processChild', {
        http: {path: '/', verb: 'get', status: 200},
        accepts: [{arg: 'data', type: 'object',  http: {source: 'req'} },
                    {arg: 'filter', type: 'object'}],
        returns: {arg: 't2CompDMDelDevStdPopContract', type: 'object'}
    });
