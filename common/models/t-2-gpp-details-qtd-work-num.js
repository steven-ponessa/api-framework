...
module.exports = function(T2gppdetailsqtdfinworknum) {
  T2gppdetailsqtdfinworknum.processChild = function(req, filter, cb) {
  ...
  T2gppdetailsqtdfinworknum.remoteMethod('processChild', {
      http: {path: '/', verb: 'get', status: 200},
      accepts: [{arg: 'data', type: 'object',  http: {source: 'req'} },
                  {arg: 'filter', type: 'object'}],
      returns: {arg: 't2gppDetailsQTDFinWorkNum', type: 'object'}
  });
};
