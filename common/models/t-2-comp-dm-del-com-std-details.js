    ...
    module.exports = function(T2compdmdelcomstddetails) {

        T2compdmdelcomstddetails.processChild = function(req, filter, cb) {
        ...
        T2compdmdelcomstddetails.remoteMethod('processChild', {
              http: {path: '/', verb: 'get', status: 200},
              accepts: [{arg: 'data', type: 'object',  http: {source: 'req'} },
                          {arg: 'filter', type: 'object'}],
              returns: {arg: 't2CompDMDelComStdDetails', type: 'object'}
          });
