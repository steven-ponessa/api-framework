...
module.exports = function(T2tieredleakworknumexport) {
    T2tieredleakworknumexport.processChild = function(req, filter, cb) {
  ...
  T2tieredleakworknumexport.remoteMethod('processChild', {
      http: {path: '/', verb: 'get', status: 200},
      accepts: [{arg: 'data', type: 'object',  http: {source: 'req'} },
                  {arg: 'filter', type: 'object'}],
      returns: {arg: 't2TieredLeakWorkNumExport', type: 'object'}
  });
};
