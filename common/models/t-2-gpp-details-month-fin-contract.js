...
module.exports = function(T2gppdetailsmonthfincontract) {
  T2gppdetailsmonthfincontract.processChild = function(req, filter, cb) {
  ...
  T2gppdetailsmonthfincontract.remoteMethod('processChild', {
      http: {path: '/', verb: 'get', status: 200},
      accepts: [{arg: 'data', type: 'object',  http: {source: 'req'} },
                  {arg: 'filter', type: 'object'}],
      returns: {arg: 't2gppDetailsMonthFinContract', type: 'object'}
  });
};
