...
module.exports = function(T2compdmsoldevslmexport) {
  T2compdmsoldevslmexport.processChild = function(req, filter, cb) {
  ...
  T2compdmsoldevslmexport.remoteMethod('processChild', {
      http: {path: '/', verb: 'get', status: 200},
      accepts: [{arg: 'data', type: 'object',  http: {source: 'req'} },
                  {arg: 'filter', type: 'object'}],
      returns: {arg: 't2CompDMSolDevSLMExport', type: 'object'}
  });
};
