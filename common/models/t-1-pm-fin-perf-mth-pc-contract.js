...
module.exports = function (T1PMFinPerfMthPCContract) {
  T1PMFinPerfMthPCContract.processChild = function (req, filter, cb) {
  ...
  T1PMFinPerfMthPCContract.remoteMethod('processChild', {
    http: { path: '/', verb: 'get', status: 200 },
    accepts: [{ arg: 'data', type: 'object', http: { source: 'req' } },
    { arg: 'filter', type: 'object' }],
    returns: { arg: 't1PMFinPerfMthPCContract', type: 'object' }
  });
