...
module.exports = function(T2ubexpanworknum) {
    T2ubexpanworknum.processChild = function(req, filter, cb) {
  ...
  T2ubexpanworknum.remoteMethod('processChild', {
      http: {path: '/', verb: 'get', status: 200},
      accepts: [{arg: 'data', type: 'object',  http: {source: 'req'} },
                  {arg: 'filter', type: 'object'}],
      returns: {arg: 't2UBExpanWorkNum', type: 'object'}
  });
};
