    ...
    module.exports = function(T2compdmsolusgdetails) {

        T2compdmsolusgdetails.processChild = function(req, filter, cb) {
        ...
        T2compdmsolusgdetails.remoteMethod('processChild', {
              http: {path: '/', verb: 'get', status: 200},
              accepts: [{arg: 'data', type: 'object',  http: {source: 'req'} },
                          {arg: 'filter', type: 'object'}],
              returns: {arg: 't2CompDMSolUsgDetails', type: 'object'}
          });
