...
module.exports = function(T2gppsideqtdfin) {

    T2gppsideqtdfin.processChild = function(req, filter, cb) {
        this.process(req, filter, function(err, message) {
          ...
          try {
            ...
            var jsonData = {
              ...
              "TITLE" : "QTD Financial Performance",
    ...
    T2gppsideqtdfin.remoteMethod('processChild', {
        http: {path: '/', verb: 'get', status: 200},
        accepts: [{arg: 'data', type: 'object',  http: {source: 'req'} },
                    {arg: 'filter', type: 'object'}],
        returns: {arg: 't2gppSideQTDFin', type: 'object'}
    });
