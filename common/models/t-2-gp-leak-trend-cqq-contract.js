...
module.exports = function (T2gpleaktrendcqqcontract) {
  T2gpleaktrendcqqcontract.processChild = function (req, filter, cb) {
  ...
  T2gpleaktrendcqqcontract.remoteMethod('processChild', {
    http: { path: '/', verb: 'get', status: 200 },
    accepts: [{ arg: 'data', type: 'object', http: { source: 'req' } },
    { arg: 'filter', type: 'object' }],
    returns: { arg: 't2GPLeakTrendCQQContract', type: 'object' }
  });
