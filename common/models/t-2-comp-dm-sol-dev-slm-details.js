    ...
    module.exports = function(T2compdmsoldevslmdetails) {

        T2compdmsoldevslmdetails.processChild = function(req, filter, cb) {
                ...
                if (!message.length <= 0) {
                    ...
                    for (var i = 0; i < message.length; i++) {
                        formatedJson.DATA.push({
                            ...
                            "NON_STD_USED":message[i].NON_STDNRT_PMT
        ...
        T2compdmsoldevslmdetails.remoteMethod('processChild', {
              http: {path: '/', verb: 'get', status: 200},
              accepts: [{arg: 'data', type: 'object',  http: {source: 'req'} },
                          {arg: 'filter', type: 'object'}],
              returns: {arg: 't2CompDMSolDevSLMDetails', type: 'object'}
          });
