...
module.exports = function(T2gpleakpopupcqmworknum) {

  T2gpleakpopupcqmworknum.processChild = function(req, filter, cb) {
    ...
    T2gpleakpopupcqmworknum.remoteMethod('processChild', {
        http: {path: '/', verb: 'get', status: 200},
        accepts: [{arg: 'data', type: 'object',  http: {source: 'req'} },
                    {arg: 'filter', type: 'object'}],
        returns: {arg: 't2GPLeakPopupCQMWorkNum', type: 'object'}
    });
