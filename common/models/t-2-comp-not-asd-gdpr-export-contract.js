...
module.exports = function (T2compnotasdgdprexportcontract) {
	T2compnotasdgdprexportcontract.processChild = function (req, filter, cb) {
	...
	T2compnotasdgdprexportcontract.remoteMethod('processChild', {
		http: { path: '/', verb: 'get', status: 200 },
		accepts: [{ arg: 'data', type: 'object', http: { source: 'req' } },
		{ arg: 'filter', type: 'object' }],
		returns: { arg: 't2CompNotAsdGDPRExportContract', type: 'object' }
	});
};
