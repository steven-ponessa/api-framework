    ...
    module.exports = function(T2compdmdeldevstddetails) {

        T2compdmdeldevstddetails.processChild = function(req, filter, cb) {
        ...
        T2compdmdeldevstddetails.remoteMethod('processChild', {
              http: {path: '/', verb: 'get', status: 200},
              accepts: [{arg: 'data', type: 'object',  http: {source: 'req'} },
                          {arg: 'filter', type: 'object'}],
              returns: {arg: 't2CompDMDelDevStdDetails', type: 'object'}
          });
