...
module.exports = function(T2gpleakexportcqqcontract) {
  T2gpleakexportcqqcontract.processChild = function(req, filter, cb) {
...
/*      var signedValue = '';
  ...
  T2gpleakexportcqqcontract.remoteMethod('processChild', {
      http: {path: '/', verb: 'get', status: 200},
      accepts: [{arg: 'data', type: 'object',  http: {source: 'req'} },
                  {arg: 'filter', type: 'object'}],
      returns: {arg: 't2GPLeakExportCQQContract', type: 'object'}
  });
};
