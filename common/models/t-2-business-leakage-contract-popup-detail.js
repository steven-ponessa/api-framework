...
module.exports = function(T2businessleakagecontractpopupdetail) {

    T2businessleakagecontractpopupdetail.processChild = function(req, filter, cb) {
    ...
    T2businessleakagecontractpopupdetail.remoteMethod('processChild', {
        http: {path: '/', verb: 'get', status: 200},
        accepts: [{arg: 'data', type: 'object',  http: {source: 'req'} },
                    {arg: 'filter', type: 'object'}],
        returns: {arg: 't2BusinessLeakageContractPopupDetail', type: 'object'}
    });
