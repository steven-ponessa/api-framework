...
module.exports = function(T2compdmdevslmpopoppty) {

  T2compdmdevslmpopoppty.processChild = function(req, filter, cb) {
    ...
    T2compdmdevslmpopoppty.remoteMethod('processChild', {
        http: {path: '/', verb: 'get', status: 200},
        accepts: [{arg: 'data', type: 'object',  http: {source: 'req'} },
                    {arg: 'filter', type: 'object'}],
        returns: {arg: 't2CompDMDevSLMPopOppty', type: 'object'}
    });
