...
module.exports = function(T2businessleakageexpansionexclusiontrendmillions) {
  T2businessleakageexpansionexclusiontrendmillions.processChild = function(req, filter, cb) {
  ...
  T2businessleakageexpansionexclusiontrendmillions.remoteMethod('processChild', {
    http: {path: '/', verb: 'get', status: 200},
    accepts: [{arg: 'data', type: 'object',  http: {source: 'req'} },
              {arg: 'filter', type: 'object'}],
              returns: {arg: 't2businessleakageexpansionexclusiontrendmillions', type: 'object'}
  });
