...
module.exports = function(T2planhealthexclusiontrendcontract) {
  T2planhealthexclusiontrendcontract.processChild = function (req, filter, cb) {
      ...
      try {
        ...
        for (var i = 0; i < message.length; i++) {
          ...
          formatedJson.DROPD_EXCLSN.push({
            ...
            "count": message[i].DROP_EXCLSN_CNTRCT_NUM,
          ...
          formatedJson.NEW_EXCLSN.push({
              ...
              "count": message[i].NEW_EXCLSN_CNTRCT_NUM,
            ...
            formatedJson.EXISTG_EXCLSN.push({
              ...
              "count": message[i].EXISTG_EXCLSN_CNTRCT_NUM,
  ...
  T2planhealthexclusiontrendcontract.remoteMethod('processChild', {
      http: { path: '/', verb: 'get', status: 200 },
      accepts: [{ arg: 'data', type: 'object', http: { source: 'req' } },
      { arg: 'filter', type: 'object' }],
      returns: { arg: 't2planhealthexclusiontrendcontract', type: 'object' }
  });
};
