...
module.exports = function(T2gppdetailsitdfincontract) {
  T2gppdetailsitdfincontract.processChild = function(req, filter, cb) {
  ...
  T2gppdetailsitdfincontract.remoteMethod('processChild', {
      http: {path: '/', verb: 'get', status: 200},
      accepts: [{arg: 'data', type: 'object',  http: {source: 'req'} },
                  {arg: 'filter', type: 'object'}],
      returns: {arg: 't2gppDetailsITDFinContract', type: 'object'}
  });
};
