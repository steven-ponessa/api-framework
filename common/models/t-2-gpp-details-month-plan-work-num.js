...
module.exports = function(T2gppdetailsmonthplanworknum) {
  T2gppdetailsmonthplanworknum.processChild = function(req, filter, cb) {
  ...
  T2gppdetailsmonthplanworknum.remoteMethod('processChild', {
      http: {path: '/', verb: 'get', status: 200},
      accepts: [{arg: 'data', type: 'object',  http: {source: 'req'} },
                  {arg: 'filter', type: 'object'}],
      returns: {arg: 't2gppDetailsMonthPlanWorkNum', type: 'object'}
  });
};
