...
module.exports = function(T2gppsideqtrfin) {

    T2gppsideqtrfin.processChild = function(req, filter, cb) {
    ...
    T2gppsideqtrfin.remoteMethod('processChild', {
        http: {path: '/', verb: 'get', status: 200},
        accepts: [{arg: 'data', type: 'object',  http: {source: 'req'} },
                    {arg: 'filter', type: 'object'}],
        returns: {arg: 't2gppSideQtrFin', type: 'object'}
    });
