...
module.exports = function(T2gppdetailsmonthfinworknum) {
  T2gppdetailsmonthfinworknum.processChild = function(req, filter, cb) {
  ...
  T2gppdetailsmonthfinworknum.remoteMethod('processChild', {
      http: {path: '/', verb: 'get', status: 200},
      accepts: [{arg: 'data', type: 'object',  http: {source: 'req'} },
                  {arg: 'filter', type: 'object'}],
      returns: {arg: 't2gppDetailsMonthFinWorkNum', type: 'object'}
  });
};
