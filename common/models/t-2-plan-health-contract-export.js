...
module.exports = function(T2planhealthcontractexport) {
  T2planhealthcontractexport.processChild = function(req, filter, cb) {
  ...
  T2planhealthcontractexport.remoteMethod('processChild', {
      http: {path: '/', verb: 'get', status: 200},
      accepts: [{arg: 'data', type: 'object',  http: {source: 'req'} },
                  {arg: 'filter', type: 'object'}],
      returns: {arg: 't2PlanHealthContractExport', type: 'object'}
  });
};