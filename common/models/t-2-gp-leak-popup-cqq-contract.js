...
module.exports = function(T2gpleakpopupcqqcontract) {

  T2gpleakpopupcqqcontract.processChild = function(req, filter, cb) {
    ...
    T2gpleakpopupcqqcontract.remoteMethod('processChild', {
        http: {path: '/', verb: 'get', status: 200},
        accepts: [{arg: 'data', type: 'object',  http: {source: 'req'} },
                    {arg: 'filter', type: 'object'}],
        returns: {arg: 't2GPLeakPopupCQQContract', type: 'object'}
    });
