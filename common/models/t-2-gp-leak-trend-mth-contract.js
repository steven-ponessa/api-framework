...
module.exports = function (T2gpleaktrendmthcontract) {
  T2gpleaktrendmthcontract.processChild = function (req, filter, cb) {
      ...
      try {
        ...
        for (var i = 0; i < message.length; i++) {
          ...
          formatedJson.ITD.push({
            ...
            "count": message[i].ITD_CNTRCT_CNT,
          ...
          formatedJson.YTD.push({
            ...
            "count": message[i].YTD_CNTRCT_CNT,
...
/*           formatedJson.CQ.push({
          ...
          formatedJson.FC_TO_AP.push({
            ...
            "count": message[i].FAC_CNTRCT_CNT,
  ...
  T2gpleaktrendmthcontract.remoteMethod('processChild', {
    http: { path: '/', verb: 'get', status: 200 },
    accepts: [{ arg: 'data', type: 'object', http: { source: 'req' } },
    { arg: 'filter', type: 'object' }],
    returns: { arg: 't2GPLeakTrendMthContract', type: 'object' }
  });
