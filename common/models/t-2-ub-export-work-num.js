...
module.exports = function(T2ubexportworknum) {
    T2ubexportworknum.processChild = function(req, filter, cb) {
  ...
  T2ubexportworknum.remoteMethod('processChild', {
      http: {path: '/', verb: 'get', status: 200},
      accepts: [{arg: 'data', type: 'object',  http: {source: 'req'} },
                  {arg: 'filter', type: 'object'}],
      returns: {arg: 't2UBExportWorkNum', type: 'object'}
  });
};
