...
module.exports = function(T2gpleakdetailscqqworknum) {

  T2gpleakdetailscqqworknum.processChild = function(req, filter, cb) {
      ...
      T2gpleakdetailscqqworknum.remoteMethod('processChild', {
          http: {path: '/', verb: 'get', status: 200},
          accepts: [{arg: 'data', type: 'object',  http: {source: 'req'} },
                      {arg: 'filter', type: 'object'}],
          returns: {arg: 't2GPLeakDetailsCQQWorkNum', type: 'object'}
      });
