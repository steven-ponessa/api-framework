...
module.exports = function(T2gppdetailsmonthplancontract) {
  T2gppdetailsmonthplancontract.processChild = function(req, filter, cb) {
  ...
  T2gppdetailsmonthplancontract.remoteMethod('processChild', {
      http: {path: '/', verb: 'get', status: 200},
      accepts: [{arg: 'data', type: 'object',  http: {source: 'req'} },
                  {arg: 'filter', type: 'object'}],
      returns: {arg: 't2gppDetailsMonthPlanContract', type: 'object'}
  });
};
