...
module.exports = function(T2compdmdelprofcount) {

  T2compdmdelprofcount.processChild = function(req, filter, cb) {
...
/*               // might need to check if empty
    ...
    T2compdmdelprofcount.remoteMethod('processChild', {
        http: {path: '/', verb: 'get', status: 200},
        accepts: [{arg: 'data', type: 'object',  http: {source: 'req'} },
                    {arg: 'filter', type: 'object'}],
        returns: {arg: 't2CompDMDelProfCount', type: 'object'}
    });
