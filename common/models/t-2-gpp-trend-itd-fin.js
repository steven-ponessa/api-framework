...
module.exports = function(T2gpptrenditdfin) {
    T2gpptrenditdfin.processChild = function(req, filter, cb) {
...
T2gpptrenditdfin.remoteMethod('processChild', {
    http: {path: '/', verb: 'get', status: 200},
    accepts: [{arg: 'data', type: 'object',  http: {source: 'req'} },
              {arg: 'filter', type: 'object'}],
              returns: {arg: 't2gppTrendITDFin', type: 'object'}
  });
