...
module.exports = function(T2gpleakexportcqmworknum) {
  T2gpleakexportcqmworknum.processChild = function(req, filter, cb) {
...
/*    var signedValue = '';
  ...
  T2gpleakexportcqmworknum.remoteMethod('processChild', {
      http: {path: '/', verb: 'get', status: 200},
      accepts: [{arg: 'data', type: 'object',  http: {source: 'req'} },
                  {arg: 'filter', type: 'object'}],
      returns: {arg: 't2GPLeakExportCQMWorkNum', type: 'object'}
  });
};
