...
module.exports = function(T2compdmusgpopcontract) {

  T2compdmusgpopcontract.processChild = function(req, filter, cb) {
    ...
    T2compdmusgpopcontract.remoteMethod('processChild', {
        http: {path: '/', verb: 'get', status: 200},
        accepts: [{arg: 'data', type: 'object',  http: {source: 'req'} },
                    {arg: 'filter', type: 'object'}],
        returns: {arg: 't2CompDMUsgPopContract', type: 'object'}
    });
