    ...
    module.exports = function(T2compdmdeldevslmdetails) {

        T2compdmdeldevslmdetails.processChild = function(req, filter, cb) {
        ...
        T2compdmdeldevslmdetails.remoteMethod('processChild', {
              http: {path: '/', verb: 'get', status: 200},
              accepts: [{arg: 'data', type: 'object',  http: {source: 'req'} },
                          {arg: 'filter', type: 'object'}],
              returns: {arg: 't2CompDMDelDevSLMDetails', type: 'object'}
          });
