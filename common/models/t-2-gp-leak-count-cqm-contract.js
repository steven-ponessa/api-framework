...
module.exports = function(T2gpleakcountcqmcontract) {

  T2gpleakcountcqmcontract.processChild = function(req, filter, cb) {
  ...
  T2gpleakcountcqmcontract.remoteMethod('processChild', {
      http: {path: '/', verb: 'get', status: 200},
      accepts: [{arg: 'data', type: 'object',  http: {source: 'req'} },
                  {arg: 'filter', type: 'object'}],
      returns: {arg: 't2GPLeakCountCQMContract', type: 'object'}
  });
