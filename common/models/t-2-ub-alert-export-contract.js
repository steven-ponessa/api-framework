...
module.exports = function(T2ubalertexportcontract) {
  T2ubalertexportcontract.processChild = function(req, filter, cb) {
  ...
  T2ubalertexportcontract.remoteMethod('processChild', {
      http: {path: '/', verb: 'get', status: 200},
      accepts: [{arg: 'data', type: 'object',  http: {source: 'req'} },
                  {arg: 'filter', type: 'object'}],
      returns: {arg: 't2UBAlertExportContract', type: 'object'}
  });
};
