...
module.exports = function(T2gppsidemonthfin) {

    T2gppsidemonthfin.processChild = function(req, filter, cb) {
    ...
    T2gppsidemonthfin.remoteMethod('processChild', {
        http: {path: '/', verb: 'get', status: 200},
        accepts: [{arg: 'data', type: 'object',  http: {source: 'req'} },
                    {arg: 'filter', type: 'object'}],
        returns: {arg: 't2gppSideMonthFin', type: 'object'}
    });
