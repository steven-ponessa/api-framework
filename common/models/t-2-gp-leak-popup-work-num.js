...
module.exports = function(T2gpleakpopupworknum) {

  T2gpleakpopupworknum.processChild = function(req, filter, cb) {
    ...
    T2gpleakpopupworknum.remoteMethod('processChild', {
        http: {path: '/', verb: 'get', status: 200},
        accepts: [{arg: 'data', type: 'object',  http: {source: 'req'} },
                    {arg: 'filter', type: 'object'}],
        returns: {arg: 't2GPLeakPopupWorkNum', type: 'object'}
    });
