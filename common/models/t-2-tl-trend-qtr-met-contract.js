...
module.exports = function(T2tltrendqtrmetcontract) {
  T2tltrendqtrmetcontract.processChild = function(req, filter, cb) {
...
T2tltrendqtrmetcontract.remoteMethod('processChild', {
    http: {path: '/', verb: 'get', status: 200},
    accepts: [{arg: 'data', type: 'object',  http: {source: 'req'} },
              {arg: 'filter', type: 'object'}],
              returns: {arg: 't2TLTrendQtrMetContract', type: 'object'}
  });
