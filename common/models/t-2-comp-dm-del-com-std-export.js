...
module.exports = function(T2compdmdelcomstdexport) {
  T2compdmdelcomstdexport.processChild = function(req, filter, cb) {
          ...
          formatedJson.data = [];
            ...
            for (var i = 0; i < message.length; i++) {
              ...
              formatedJson.data.push({
                ...
                "CONTRACT_END_DT":message[i].CNTRCT_END_DT==null?' ':message[i].CNTRCT_END_DT,          
                "CONTRACT_STATUS":message[i].CNTRCT_STATUS==null?' ':message[i].CNTRCT_STATUS, 
  ...
  T2compdmdelcomstdexport.remoteMethod('processChild', {
      http: {path: '/', verb: 'get', status: 200},
      accepts: [{arg: 'data', type: 'object',  http: {source: 'req'} },
                  {arg: 'filter', type: 'object'}],
      returns: {arg: 't2CompDMDelComStdExport', type: 'object'}
  });
};
