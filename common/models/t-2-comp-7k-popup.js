...
module.exports = function(T2comp7kpopup) {

  T2comp7kpopup.processChild = function(req, filter, cb) {
    ...
    T2comp7kpopup.remoteMethod('processChild', {
        http: {path: '/', verb: 'get', status: 200},
        accepts: [{arg: 'data', type: 'object',  http: {source: 'req'} },
                    {arg: 'filter', type: 'object'}],
        returns: {arg: 't2Comp7KPopup', type: 'object'}
    });
