...
module.exports = function(T2gpleakexportcontract) {
  T2gpleakexportcontract.processChild = function(req, filter, cb) {
          ...
          formatedJson.data = [];
            ...
            for (var i = 0; i < message.length; i++) {
              ...
              formatedJson.data.push({
                ...
                "Current_Quarter_GP_%":calcs.calcX100(Number(message[i].CQ_GP_PCT)),
...
*/
  ...
  T2gpleakexportcontract.remoteMethod('processChild', {
      http: {path: '/', verb: 'get', status: 200},
      accepts: [{arg: 'data', type: 'object',  http: {source: 'req'} },
                  {arg: 'filter', type: 'object'}],
      returns: {arg: 't2GPLeakExportContract', type: 'object'}
  });
};
