...
module.exports = function(T2compdmsolstdcount) {

  T2compdmsolstdcount.processChild = function(req, filter, cb) {
...
/*               if (( req.query['busAttr'] == 'GEO_DESC' ) || ( req.query['busAttr'] == 'GROWTH_PLATFORM_DESC' )) {
    ...
    T2compdmsolstdcount.remoteMethod('processChild', {
        http: {path: '/', verb: 'get', status: 200},
        accepts: [{arg: 'data', type: 'object',  http: {source: 'req'} },
                    {arg: 'filter', type: 'object'}],
        returns: {arg: 't2CompDMSolStdCount', type: 'object'}
    });
