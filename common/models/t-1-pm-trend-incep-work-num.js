...
module.exports = function(T1PMTrendIncepWorkNum) {
  T1PMTrendIncepWorkNum.processChild = function(req, filter, cb) {
  ...
  T1PMTrendIncepWorkNum.remoteMethod('processChild', {
    http: {path: '/', verb: 'get', status: 200},
    accepts: [{arg: 'data', type: 'object',  http: {source: 'req'} },
              {arg: 'filter', type: 'object'}],
              returns: {arg: 't1PMTrendIncepWorkNum', type: 'object'}
  });
