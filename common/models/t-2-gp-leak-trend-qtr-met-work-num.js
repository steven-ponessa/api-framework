...
module.exports = function(T2gpleaktrendqtrmetworknum) {
  T2gpleaktrendqtrmetworknum.processChild = function(req, filter, cb) {
...
T2gpleaktrendqtrmetworknum.remoteMethod('processChild', {
    http: {path: '/', verb: 'get', status: 200},
    accepts: [{arg: 'data', type: 'object',  http: {source: 'req'} },
              {arg: 'filter', type: 'object'}],
              returns: {arg: 't2GPLeakTrendQtrMetWorkNum', type: 'object'}
  });
