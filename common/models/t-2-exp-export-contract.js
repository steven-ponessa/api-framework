...
module.exports = function(T2expexportcontract) {
    T2expexportcontract.processChild = function(req, filter, cb) {
          ...
          formatedJson.data = [];
            ...
            for (var i = 0; i < message.length; i++) {
              ...
              formatedJson.data.push({
                ...
                "EAC_GP_PCT":calcs.calcX100(Number(message[i].EAC_GP_PCT)),
  ...
  T2expexportcontract.remoteMethod('processChild', {
      http: {path: '/', verb: 'get', status: 200},
      accepts: [{arg: 'data', type: 'object',  http: {source: 'req'} },
                  {arg: 'filter', type: 'object'}],
      returns: {arg: 't2ExpExportContract', type: 'object'}
  });
};
