...
module.exports = function(T1PMContPerfPCContract) {

  T1PMContPerfPCContract.processChild = function(req, filter, cb) {
      this.process(req, filter, function(err, message) {
        ...
        if (message.length > 0) { //Avoid processing a empty result set
          jsonData = {
            ...
            jsonData.data[0].prev_value = (message[0].PREVIOUS_MONTH_ITD_TO_PC, valueDecimalPlace);
            ...
            jsonData.data[1].prev_value = (message[0].PREVIOUS_MONTH_EAC_TO_PC, valueDecimalPlace);
            ...
            jsonData.data[2].prev_value = (message[0].PREVIOUS_MONTH_YTD_TO_PC, valueDecimalPlace);
  ...
  T1PMContPerfPCContract.remoteMethod('processChild', {
      http: {path: '/', verb: 'get', status: 200},
      accepts: [{arg: 'data', type: 'object',  http: {source: 'req'} },
                  {arg: 'filter', type: 'object'}],
      returns: {arg: 't1PMContPerfPCContract', type: 'object'}
  });
