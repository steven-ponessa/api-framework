...
module.exports = function(T2gppexportworknum) {
    T2gppexportworknum.processChild = function(req, filter, cb) {
  ...
  T2gppexportworknum.remoteMethod('processChild', {
      http: {path: '/', verb: 'get', status: 200},
      accepts: [{arg: 'data', type: 'object',  http: {source: 'req'} },
                  {arg: 'filter', type: 'object'}],
      returns: {arg: 't2gppExportWorkNum', type: 'object'}
  });
};
