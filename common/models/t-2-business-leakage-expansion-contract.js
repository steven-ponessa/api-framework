...
module.exports = function(T2businessleakageexpansioncontract) {

  T2businessleakageexpansioncontract.processChild = function(req, filter, cb) {
      this.process(req, filter, function(err, message) {
        ...
        try {
            ...
            message.forEach(function (element) {
                ...
                cq.prevQtr.count = element.PQ_CNTRCT_CNT;
  ...
  T2businessleakageexpansioncontract.remoteMethod('processChild', {
      http: {path: '/', verb: 'get', status: 200},
      accepts: [{arg: 'data', type: 'object',  http: {source: 'req'} },
                  {arg: 'filter', type: 'object'}],
      returns: {arg: 't2BusinessLeakageExpansionContract', type: 'object'}
  });
