...
module.exports = function(T2planhealthworkpopupdetail) {

    T2planhealthworkpopupdetail.processChild = function(req, filter, cb) {
          ...
          try {
                ...
                if(message.length == 0) {
                    ...
                    formatedJson = [{
                        ...
                        "FCAST_DATE": message[0].FCAST_DATE,
    ...
    T2planhealthworkpopupdetail.remoteMethod('processChild', {
        http: {path: '/', verb: 'get', status: 200},
        accepts: [{arg: 'data', type: 'object',  http: {source: 'req'} },
                    {arg: 'filter', type: 'object'}],
        returns: {arg: 't2PlanHealthWorkPopupDetail', type: 'object'}
    });
