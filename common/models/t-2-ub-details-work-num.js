...
module.exports = function(T2ubdetailsworknum) {
    T2ubdetailsworknum.processChild = function(req, filter, cb) {
  ...
  T2ubdetailsworknum.remoteMethod('processChild', {
      http: {path: '/', verb: 'get', status: 200},
      accepts: [{arg: 'data', type: 'object',  http: {source: 'req'} },
                  {arg: 'filter', type: 'object'}],
      returns: {arg: 't2UBDetailsWorkNum', type: 'object'}
  });
};
