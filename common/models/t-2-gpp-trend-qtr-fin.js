...
module.exports = function(T2gpptrendqtrfin) {
    T2gpptrendqtrfin.processChild = function(req, filter, cb) {
...
T2gpptrendqtrfin.remoteMethod('processChild', {
    http: {path: '/', verb: 'get', status: 200},
    accepts: [{arg: 'data', type: 'object',  http: {source: 'req'} },
              {arg: 'filter', type: 'object'}],
              returns: {arg: 't2gppTrendQtrFin', type: 'object'}
  });
