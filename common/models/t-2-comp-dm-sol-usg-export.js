...
module.exports = function(T2compdmsolusgexport) {
  T2compdmsolusgexport.processChild = function(req, filter, cb) {
          ...
          formatedJson.data = [];
            ...
            for (var i = 0; i < message.length; i++) {
              ...
              formatedJson.data.push({
                ...
                "OPPTNY_STAT": message[i].OPPTNY_STAT,
  ...
  T2compdmsolusgexport.remoteMethod('processChild', {
      http: {path: '/', verb: 'get', status: 200},
      accepts: [{arg: 'data', type: 'object',  http: {source: 'req'} },
                  {arg: 'filter', type: 'object'}],
      returns: {arg: 't2CompDMSolUsgExport', type: 'object'}
  });
};
