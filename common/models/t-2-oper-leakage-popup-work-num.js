...
module.exports = function(T2operleakagepopupworknum) {

    T2operleakagepopupworknum.processChild = function(req, filter, cb) {
    ...
    T2operleakagepopupworknum.remoteMethod('processChild', {
        http: {path: '/', verb: 'get', status: 200},
        accepts: [{arg: 'data', type: 'object',  http: {source: 'req'} },
                    {arg: 'filter', type: 'object'}],
        returns: {arg: 't2OperLeakagePopupWorkNum', type: 'object'}
    });
