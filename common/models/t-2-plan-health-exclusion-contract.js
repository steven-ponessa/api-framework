...
module.exports = function(T2planhealthexclusioncontract) {

  T2planhealthexclusioncontract.processChild = function(req, filter, cb) {
  ...
  T2planhealthexclusioncontract.remoteMethod('processChild', {
      http: {path: '/', verb: 'get', status: 200},
      accepts: [{arg: 'data', type: 'object',  http: {source: 'req'} },
                  {arg: 'filter', type: 'object'}],
      returns: {arg: 't2PlanHealthExclusionContract', type: 'object'}
  });
