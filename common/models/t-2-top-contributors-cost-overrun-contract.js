...
module.exports = function(T2topcontributorscostoverruncontract) {

    T2topcontributorscostoverruncontract.processChild = function(req, filter, cb) {
    ...
    T2topcontributorscostoverruncontract.remoteMethod('processChild', {
        http: {path: '/', verb: 'get', status: 200},
        accepts: [{arg: 'data', type: 'object',  http: {source: 'req'} },
                    {arg: 'filter', type: 'object'}],
        returns: {arg: 'T2topcontributorscostoverruncontract', type: 'object'}
    });
