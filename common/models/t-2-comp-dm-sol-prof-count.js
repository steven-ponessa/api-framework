...
module.exports = function(T2compdmsolprofcount) {

  T2compdmsolprofcount.processChild = function(req, filter, cb) {
...
/*               if (( req.query['busAttr'] == 'GEO_DESC' ) || ( req.query['busAttr'] == 'GROWTH_PLATFORM_DESC' )) {
    ...
    T2compdmsolprofcount.remoteMethod('processChild', {
        http: {path: '/', verb: 'get', status: 200},
        accepts: [{arg: 'data', type: 'object',  http: {source: 'req'} },
                    {arg: 'filter', type: 'object'}],
        returns: {arg: 't2CompDMSolProfCount', type: 'object'}
    });
