...
module.exports = function(T2pmproccomppgpopupsum) {

    T2pmproccomppgpopupsum.processChild = function(req, filter, cb) {
    ...
    T2pmproccomppgpopupsum.remoteMethod('processChild', {
        http: {path: '/', verb: 'get', status: 200},
        accepts: [{arg: 'data', type: 'object',  http: {source: 'req'} },
                    {arg: 'filter', type: 'object'}],
        returns: {arg: 't2PMProcCompPGPopupSum', type: 'object'}
    });
