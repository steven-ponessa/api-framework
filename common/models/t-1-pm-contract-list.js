...
module.exports = function(T1pmcontractList) {
  T1pmcontractList.processChild = function(req, filter, cb) {
  ...
  T1pmcontractList.remoteMethod('processChild', {
      http: {path: '/', verb: 'get', status: 200},
      accepts: [{arg: 'data', type: 'object',  http: {source: 'req'} },
                  {arg: 'filter', type: 'object'}],
      returns: {arg: 't1PMContractList', type: 'object'}
  });
};
