...
module.exports = function(T2gpleakpopupcontract) {

  T2gpleakpopupcontract.processChild = function(req, filter, cb) {
    ...
    T2gpleakpopupcontract.remoteMethod('processChild', {
        http: {path: '/', verb: 'get', status: 200},
        accepts: [{arg: 'data', type: 'object',  http: {source: 'req'} },
                    {arg: 'filter', type: 'object'}],
        returns: {arg: 't2GPLeakPopupContract', type: 'object'}
    });
