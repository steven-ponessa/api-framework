...
module.exports = function(T2comppgpopupdet) {

    T2comppgpopupdet.processChild = function(req, filter, cb) {
    ...
    T2comppgpopupdet.remoteMethod('processChild', {
        http: {path: '/', verb: 'get', status: 200},
        accepts: [{arg: 'data', type: 'object',  http: {source: 'req'} },
                    {arg: 'filter', type: 'object'}],
        returns: {arg: 't2CompPGPopupDet', type: 'object'}
    });
