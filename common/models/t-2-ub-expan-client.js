...
module.exports = function(T2ubexpanclient) {
    T2ubexpanclient.processChild = function(req, filter, cb) {
    ...
    try {
        ...
        if(message.length == 0) { 
            ...
            "Load_Date":message[0].DATA_LOAD_DESC
          }
  ...
  T2ubexpanclient.remoteMethod('processChild', {
      http: {path: '/', verb: 'get', status: 200},
      accepts: [{arg: 'data', type: 'object',  http: {source: 'req'} },
                  {arg: 'filter', type: 'object'}],
      returns: {arg: 't2UBExpanClient', type: 'object'}
  });
};
