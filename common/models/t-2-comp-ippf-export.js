...
module.exports = function(T2compippfexport) {
  T2compippfexport.processChild = function(req, filter, cb) {
    ...
    try {
        ...
        if(message.length == 0) { 
          ...
          "FORCAST_OVERRIDE_STATUS":message[i].FORCAST_OVERRIDE_STATUS,
          "FORCAST_SUBMITER_NOTESID":message[i].FORCAST_SUBMITER_NOTESID,
          "FORCAST_SUBMISSION_TIMESTAMP":message[i].FORCAST_SUBMISSION_TIMESTAMP,
          ...
          "PM_NOTESID":message[i].PM_NOTESID,
          ...
          "POC_INDICATOR":message[i].POC_IND,
  ...
  T2compippfexport.remoteMethod('processChild', {
      http: {path: '/', verb: 'get', status: 200},
      accepts: [{arg: 'data', type: 'object',  http: {source: 'req'} },
                  {arg: 'filter', type: 'object'}],
      returns: {arg: 't2CompIPPFExport', type: 'object'}
  });
};
