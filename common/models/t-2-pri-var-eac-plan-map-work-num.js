...
module.exports = function(T2privareacplanmapworknum) {
  T2privareacplanmapworknum.processChild = function(req, filter, cb) {
  ...
  T2privareacplanmapworknum.remoteMethod('processChild', {
      http: {path: '/', verb: 'get', status: 200},
      accepts: [{arg: 'data', type: 'object',  http: {source: 'req'} },
                  {arg: 'filter', type: 'object'}],
      returns: {arg: 't2PriVarEacPlanMapWorkNum', type: 'object'}
  });
};
