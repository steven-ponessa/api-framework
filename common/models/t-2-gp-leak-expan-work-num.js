...
module.exports = function(T2gpleakexpanworknum) {
    T2gpleakexpanworknum.processChild = function(req, filter, cb) {
  ...
  T2gpleakexpanworknum.remoteMethod('processChild', {
      http: {path: '/', verb: 'get', status: 200},
      accepts: [{arg: 'data', type: 'object',  http: {source: 'req'} },
                  {arg: 'filter', type: 'object'}],
      returns: {arg: 't2GPLeakExpanWorkNum', type: 'object'}
  });
};
