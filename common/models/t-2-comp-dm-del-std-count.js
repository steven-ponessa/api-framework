...
module.exports = function(T2compdmdelstdcount) {

  T2compdmdelstdcount.processChild = function(req, filter, cb) {
...
/*               // might need to check if empty
    ...
    T2compdmdelstdcount.remoteMethod('processChild', {
        http: {path: '/', verb: 'get', status: 200},
        accepts: [{arg: 'data', type: 'object',  http: {source: 'req'} },
                    {arg: 'filter', type: 'object'}],
        returns: {arg: 't2CompDMDelStdCount', type: 'object'}
    });
