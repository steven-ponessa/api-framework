...
module.exports = function(T2topcontributorscontractpopupdetail) {

    T2topcontributorscontractpopupdetail.processChild = function(req, filter, cb) {
    ...
    T2topcontributorscontractpopupdetail.remoteMethod('processChild', {
        http: {path: '/', verb: 'get', status: 200},
        accepts: [{arg: 'data', type: 'object',  http: {source: 'req'} },
                    {arg: 'filter', type: 'object'}],
        returns: {arg: 't2TopContributorsContractPopupDetail', type: 'object'}
    });
