...
module.exports = function(T2compdmusgpopoppty) {

  T2compdmusgpopoppty.processChild = function(req, filter, cb) {
    ...
    T2compdmusgpopoppty.remoteMethod('processChild', {
        http: {path: '/', verb: 'get', status: 200},
        accepts: [{arg: 'data', type: 'object',  http: {source: 'req'} },
                    {arg: 'filter', type: 'object'}],
        returns: {arg: 't2CompDMUsgPopOppty', type: 'object'}
    });
