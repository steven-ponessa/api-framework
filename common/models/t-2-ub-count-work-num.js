...
module.exports = function(T2ubcountworknum) {

    T2ubcountworknum.processChild = function(req, filter, cb) {
  ...
  T2ubcountworknum.remoteMethod('processChild', {
      http: {path: '/', verb: 'get', status: 200},
      accepts: [{arg: 'data', type: 'object',  http: {source: 'req'} },
                  {arg: 'filter', type: 'object'}],
      returns: {arg: 't2UBCountWorknum', type: 'object'}
  });
