...
module.exports = function(T2gpleaktrendmthmetcontract) {
  T2gpleaktrendmthmetcontract.processChild = function(req, filter, cb) {
...
T2gpleaktrendmthmetcontract.remoteMethod('processChild', {
    http: {path: '/', verb: 'get', status: 200},
    accepts: [{arg: 'data', type: 'object',  http: {source: 'req'} },
              {arg: 'filter', type: 'object'}],
              returns: {arg: 't2GPLeakTrendMthMetContract', type: 'object'}
  });
