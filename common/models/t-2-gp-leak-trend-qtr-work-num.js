...
module.exports = function(T2gpleaktrendqtrworknum) {
  T2gpleaktrendqtrworknum.processChild = function(req, filter, cb) {
...
*/
  ...
  T2gpleaktrendqtrworknum.remoteMethod('processChild', {
    http: {path: '/', verb: 'get', status: 200},
    accepts: [{arg: 'data', type: 'object',  http: {source: 'req'} },
              {arg: 'filter', type: 'object'}],
              returns: {arg: 't2GPLeakTrendQtrWorkNum', type: 'object'}
  });
