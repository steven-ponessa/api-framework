...
module.exports = function(T2pmproccompcospopup) {

    T2pmproccompcospopup.processChild = function(req, filter, cb) {
    ...
    T2pmproccompcospopup.remoteMethod('processChild', {
        http: {path: '/', verb: 'get', status: 200},
        accepts: [{arg: 'data', type: 'object',  http: {source: 'req'} },
                    {arg: 'filter', type: 'object'}],
        returns: {arg: 't2PMProcCompCOSPopup', type: 'object'}
    });
